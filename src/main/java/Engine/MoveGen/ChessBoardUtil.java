...
public class ChessBoardUtil {
        ...
        for (int i = 0; i < fenPieces.length(); i++) {
            ...
            switch (character) {
                ...
                case 'P':
                    ...
                    break;
                case 'N':
                    cb.pieces[WHITE][KNIGHT] |= Util.POWER_LOOKUP[positionCount--];
                    break;
                case 'B':
                ...
                case 'p':
                    ...
                    break;
                case 'n':
                    cb.pieces[BLACK][KNIGHT] |= Util.POWER_LOOKUP[positionCount--];
                    break;
                case 'b':
    ...
    public static void init(ChessBoard cb) {
        ...
        cb.friendlyPieces[WHITE] = cb.pieces[WHITE][PAWN] | cb.pieces[WHITE][BISHOP] | cb.pieces[WHITE][KNIGHT] | cb.pieces[WHITE][KING] | cb.pieces[WHITE][ROOK]
                | cb.pieces[WHITE][QUEEN];
        cb.friendlyPieces[BLACK] = cb.pieces[BLACK][PAWN] | cb.pieces[BLACK][BISHOP] | cb.pieces[BLACK][KNIGHT] | cb.pieces[BLACK][KING] | cb.pieces[BLACK][ROOK]
